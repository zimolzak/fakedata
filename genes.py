...
# Pao W, Girard N. New driver mutations in non-small-cell lung cancer.
# Lancet Oncol. 2011 Feb;12(2):175-180. PMID: 21277552
...
for i, gene in enumerate(genes_for_this_hist):
    ...
    genes_for_this_hist[i] = gene + alteration_str
